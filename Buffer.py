...
class Buffer():
    def __init__(self, tfrecord_file, buffer_size = 100000, batch_size=64, visual_state_dims=(108, 144, 3), numerical_state_dims = 28, action_idx_dims=1, y_target_dims=1):#64, 1e5
